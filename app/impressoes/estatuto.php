...
$texto     = $cfg['CFG_TEXTO_ESTATUTO']  ?? '';

// Fallback: se não há texto no banco, serve o PDF estático
if (!trim((string)$texto)) {
    $pdfPath = PATH_ROOT . '/Documentos/ESTATUTO.pdf';
    if (file_exists($pdfPath)) {
        header('Content-Type: application/pdf');
        header('Content-Disposition: inline; filename="Estatuto-Social.pdf"');
...
<head>
    <meta charset="UTF-8">
    <title>Estatuto — <?= $h($empresa) ?></title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .imp-empresa-nome {
            font-size: 14px; font-weight: 800; color: #3b5bdb;
        ...
        .imp-doc-title {
            ...
            letter-spacing: .08em; color: #3b5bdb;
        }
    ...
    <div class="imp-doc">
        ...
        <div class="imp-header">
            ...
            <div class="imp-header-badge">
                <div class="imp-doc-title">Estatuto</div>
        ...
        <?php else: ?>
            <div class="doc-body-vazio">
                Nenhum texto de estatuto cadastrado.<br>
